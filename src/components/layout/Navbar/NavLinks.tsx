			...
			{navLinks.map((link, index) => {
				...
				return (
					<Link
						...
						<span className='absolute rounded-full  inset-0 z-0 bg-primary-dark/5 opacity-0 transition-opacity duration-150 group-hover:opacity-100' />

						{/* <span className='absolute bottom-0 left-2 h-0.5 w-0 bg-primary-dark transition-all duration-150 group-hover:w-full' /> */}
